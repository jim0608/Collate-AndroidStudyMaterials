...
public class TimeUtils {
     ...
     * @return
     */
    public static boolean isTimeout(long outtime) {
        boolean isOut;
        isOut = System.currentTimeMillis() - lastCallTime >= outtime;
        if (isOut) lastCallTime = System.currentTimeMillis();
        return isOut;
    }
}
